...
class AddEditCustomerWithDebits extends React.PureComponent {
  // get static context
  // constructor
    ...
    return (
      <Container fluid className="main-content-container px-4 pb-4">
        ...
        <Row noGutters className="page-header py-4" style={{ justifyContent: "space-between" }}>
          <PageTitle
            sm="4"
            title="Add Customer With Debits"
...
export default AddEditCustomerWithDebits;
