...
export class CustomerWithDebits extends PureComponent {
  componentDidMount() {
      ...
      <div>
        <Container fluid className="main-content-container px-4">
          ...
          <Row noGutters className="page-header py-4 d-flex justify-between">
            <PageTitle
              sm="4"
              title="Customer With Debits List"
            ...
            <Button
              ...
              theme="warning"
              size="lg"
              onClick={() => history.push("/add-customer-with-debits-veresiye")}
            >
              Add Customer With Debits
            </Button>
          </Row>
          {/* Default Light Table */}
          <Row>
