...
class AddEditSupplier extends React.PureComponent {
  // get static context
  // constructor
      ...
      <Container fluid className="main-content-container px-4 pb-4">
        ...
        <Row noGutters className="page-header py-4" style={{ justifyContent: "space-between" }}>
          ...
          <Button
            ...
            className="px-2"
            onClick={() =>
              this.props.history.replace("/supplier-list", {
                isComingBack: true
              })
            }
          >
                  ...
                  <React.Fragment>
                    ...
                    <Row>
                      <Col lg="12">
                        <Fileds
                          id="bankDetailsIBAN"
                          name="bankDetailsIBAN"
                          placeholder="Banka Detayları (IBAN)"
                          value={bankDetailsIBAN}
                          onChange={this.handleChange}
                        />
                      </Col>
                    </Row>
                    <Row>
                      ...
                      <Col lg="6">
                        <Fileds
                          ...
                          placeholder="Şirket iletişim sorumlusu"
